...
const GoTop = ({props}:{props:RefObject<HTMLDivElement>}) => {
  ...
  return (
    <>
      <div className={`dark:bg-[#9092DA] bg-white rounded-full fixed md:bottom-5 md:right-8 border-2 border-black p-2.5 m-2 cursor-pointer max-md:bottom-5 max-md:right-10 ${(showGoTop)? "":"hidden"}`} onClick={handleScrollUp}>
          <span>
            <svg
              fill='#000'
              width="16px"
